const Footer = () => {
  return (
    <footer className="w-full bg-[#DFE1FB]/50 ">
        ...
        <div className="py-10 flex justify-between items-center flex-col gap-8 xl:flex-row">
          <div className="flex items-center flex-col xl:flex-row ">
            ...
            <ul className="text-lg  flex items-center flex-col md:flex-row  py-8 gap-6 md:gap-12 xl:border-l border-gray-200 xl:ml-11 xl:pl-11 transition-all duration-500">
              ...
              <li>
                <a href="/all-classes" className="text-gray-800 hover:text-indigo-600">
                  Classes
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/services" className="text-gray-800 hover:text-indigo-600">
                  Services
                </a>
              </li>
              <li>
                <a href="/updates" className="text-gray-800 hover:text-indigo-600">
                  Updates
                </a>
              </li>
            </ul>
        ...
        <div className="py-7 border-t border-gray-200">
          <div className="flex items-center justify-center">
            <span className="text-gray-400 cursor-pointer ">
              ©<a href="https://pagedone.io/">EduPortal </a>
