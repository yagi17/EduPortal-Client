const Stats = () => {
  return (
    <section className="lg:max-w-3xl mx-auto my-32">
      {/* <h2 className="lg:text-4xl text-2xl font-bold text-center">Highlights</h2> */}
      <div className="stats shadow w-full mx-auto">
        <div className="stat">
          ...
          <div className="stat-desc">Happy Students</div>
        </div>
